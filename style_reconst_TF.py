...
layer_name = 'vgg19/conv4/1/Relu:0'

# Content Image
img = nets.utils.load_img('guernica.jpg', target_size=(img_width, img_height))
if (show_pictures == 1):
    imshow(img[0])
...
loss = (1 / (4 * N.value**2 * M.value**2)) * tf.reduce_sum(tf.pow(S - L, 2))
